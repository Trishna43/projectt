...
if(isset($_POST['insert_product'])){
  $product_title=$_POST['insert_product'];
  ...
  or $product_image1=='' or $product_image2=='' or $product_image3==''){
    ...
    exit();
      ...
      move_updated_file($temp_image1,"./product_images/$product_image1");
      move_updated_file($temp_image2,"./product_images/$product_image2");
      move_updated_file($temp_image3,"./product_images/$product_image3");
      //insert query
      $inser_products="insert into products (product_title,product_description,
      product_keywords,category_id,brand_id,product_image1,product_image2,
      product_image3,product_price,date,status) value('$product_title','$description','$product_keywords','$product_category','$product_Brands',
  ...
  <div class="container mt-3">
    ...
    <form action=""method="post" enctype="multipart/form-dat">
      ...
      <div class="form-outline mb-4 w-50 m-auto">
       ...
       <!--img 3-->
       <div class="form-outline mb-4 w-50 m-auto">
        <label for="product_image3"class="form-lable">Product image 1</label>
